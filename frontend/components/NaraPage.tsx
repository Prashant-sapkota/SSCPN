  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-screen-2xl mx-auto px-2 sm:px-3 lg:px-6 py-q0 md:py-12">
          <div className="max-w-5xl mx-auto text-center">
            <div className="inline-flex items-center text-red-700 font-bold uppercase tracking-widest text-sm mb-6 bg-red-50 px-4 py-2 rounded-full">
              <Star size={30} className="mr-2 fill-current" />
              <span>राजनीतिक आह्वान</span>
            </div>
            <h1 className="text-6xl md:text-7xl font-bold text-gray-900 font-['Google_Sans'] leading-tight mb-6">पार्टीका नाराहरू</h1>
            <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto font-['Google_Sans'] leading-relaxed">
            ...
            return (
              <article key={index} className="py-7 md:py-9 border-b border-gray-200 last:border-b-0">
                <div className="flex items-start gap-5 md:gap-8">
                  <div className="flex-shrink-0 text-4xl md:text-6xl font-bold font-['Google_Sans'] text-red-800 leading-none min-w-[2.5rem] md:min-w-[3.5rem]">
                    {toNepaliNumber(index + 1)}
                  </div>
                  <p className="text-gray-800 text-lg md:text-2xl leading-relaxed font-['Google_Sans']">{textWithoutNumber}</p>
                </div>
              </article>
            );
          })}
